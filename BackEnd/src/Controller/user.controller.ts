...
export const createUser = async(req: Request, res: Response)=>{
    try {
        ...
        const {name, email, password, role, specialization_area}:User = req.body
      ...
      const pool = await mssql.connect(sqlConfig)
        ...
        .input('specialization_area', mssql.VarChar, specialization_area)
...
export const getAllUsers = async(req:Request, res: Response)=>{
    ...
    // }
        ...
        let users = await dbhelper.execute("getAllUsers")
...
export const updateUser = async (req: Request, res: Response) => {
    try {
        ...
        const {name, email, role, password, specialization_area}:User = req.body
      ...
      let user = await (dbhelper.execute("updateUser", { user_id:id, name, email, role, password:hashed_pwd, specialization_area  }));
